  ...
  class PluginClass extends \Puvox\wp_plugin
  {
	...
	public function declare_settings()
	{
		...
		[	
			...
			'random_string'		=>$this->helpers->random_string(),
			//
	...
	{  
		...
		<?php if ($this->active_tab=="Options") 
		{
			...
			if( $this->checkSubmission() ) { 
				...
				$this->opts['menu_in_footer']	= $this->post_option_is_set('menu_in_footer');
				$this->opts['use_nofollow']  	= $this->post_option_is_set('use_nofollow');
				$this->opts['use_caching']  	= (int) $this->post_option_value('use_caching');
				$this->opts['show_privacy_note']= $this->post_option_is_set('show_privacy_note');
				$this->opts['privacy_message']	= wp_kses($this->post_option_value('privacy_message'), $allowed);
				$this->opts['privacy_agree_button_chars']=sanitize_text_field ($this->post_option_value('privacy_agree_button_chars'));
